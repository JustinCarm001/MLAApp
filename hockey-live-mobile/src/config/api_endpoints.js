// API Endpoints Configuration for Hockey Live App
export const API_CONFIG = {
  ...
  endpoints: {
    ...
    teams: {
      ...
      add_player: "/teams/{id}/players",
      update_player: "/teams/{id}/players/{player_id}",
      delete_player: "/teams/{id}/players/{player_id}",
